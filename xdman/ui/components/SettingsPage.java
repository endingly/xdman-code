...
public class SettingsPage extends JPanel implements ActionListener, ListSelectionListener {
	...
	JCheckBox chkHaltAfterFinish, chkKeepAwake, chkExecCmd, chkExecAntivir, chkAutoStart;
	...
	private static final String chromeWebStoreURL = "https://chrome.google.com/webstore/detail/xdm-browser-monitor/bgpkelneombgembocnickiddlbebmica",
			ffAMOURL = "http://xdman.sourceforge.net/addons/xdm_ff_webext.xpi",
			operaExtURL = "http://xdman.sourceforge.net/addons/xdm_chromium.crx",
			directCRXURL = "http://xdman.sourceforge.net/addons/xdm_chromium.crx";
	...
	private JPanel createPasswordPanel() {
		...
		lbl64.setBounds(15, y, 350 - 30, h);
		p.add(lbl64);
		y += h;

		h = 25;
		txtCredHostName = new JTextField();
		txtCredHostName.setBounds(15, y, 350 - 30 - 10, h);
		...
		txtUserName.setBounds(15, y, 350 - 30 - 10, h);
		...
		txtPassword.setBounds(15, y, 320 - 10, h);
